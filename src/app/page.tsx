    ...
    case 'intro':
      return (
        <>
          ...
          {/* Botão Admin - canto inferior direito */}
          <button
            onClick={() => setScreen('admin')}
            className="fixed bottom-4 right-4 z-50 px-4 py-2.5 rounded-full bg-gray-800 hover:bg-gray-700 text-white shadow-lg hover:shadow-xl transition-all flex items-center gap-2 text-sm font-medium"
